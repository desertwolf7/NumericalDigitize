...
8. Быстрое добавление кольца в полигон
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
В случае, когда необходимо сделать быстро кольцо в полигоне, исключив из него
территорию, которую занимает другой полигон из того же или другого слоя, это
можно сделать следующим образом. Сделайте редактируемым слой, в котором
находится полигон, который необходимо вырезать из исходного полигона, нажмите
|icon_edit| и выберите необходимый объект. Скопируйте его координаты в буфер
обмена нажав кнопку |copy_coordinates|. Перейдите к редактированию исходного
полигона таким же образом, нажмите кнопку |add_ring|, в перечне частей объекта
активируйте новое кольцо и вставьте координаты кнопкой |paste_coordinates|.

9. Выравнивание границы объекта по границе другого объекта
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
Для выполнения этой операции сделайте редактируемым слой, в котором находится
объект, по границе которого будет производится выравнивание, нажмите
|icon_edit| и выберите необходимый объект. Определите перечень точек
границы, по которым будет произведено выравнивание, выделите их и скопируйте их
координаты в буфер обмена, нажав кнопку |copy_coordinates|. Перейдите к
редактированию изменяемого объекта. Добавьте или удалите точки изменяемого
отрезка границы таким образом, чтобы их количество совпадало с числом точек
границы объекта, к которому будет осуществляться привязка. Выделите эти точки и
нажмите кнопку |paste_coordinates|.

10. Прочие операции
~~~~~~~~~~~~~~~~~~~
На Ваше усмотрение возможно проведение других операций, подобных операциям,
указанным в пукнтах 8 и 9. Но учтите, что таким образом редактируются или
создаются одиночные объекты. Для проведения массовых операций над объектами
предпочтительно использовать другие инструменты.
